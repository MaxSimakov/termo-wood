...
; /* Start:/bitrix/templates/termo-wood.ru/gallery-project/core.js*/
/**
 * 
...
/* End */
;
; /* Start:/bitrix/templates/termo-wood.ru/gallery-project/gallery.js*/
/**
...
/* End */
;
; /* Start:/bitrix/templates/termo-wood.ru/gallery-project/image.js*/
var _imgInterval,
...
/* End */
;
; /* Start:/js/fancybox/source/jquery.fancybox.pack.js*/
...
/* End */
;
; /* Start:/js/fancybox/source/helpers/jquery.fancybox-thumbs.js*/
...
;
; /* Start:/js/project.js*/
jQuery(document).ready(function(){jQuery(".fancybox").fancybox();jQuery(".apinull").fancybox({padding:0,type:'ajax'});var $activeLink=jQuery('.footer_top_menu .block').find('[href="'+location.pathname+location.search+'"]');$activeLink.addClass('active');});jQuery('[data-form-name]').fancybox({'type':'ajax','padding':0,beforeLoad:function(){this.href='/ajax/'+this.element.data("form-name")+'.php';;}});
/* End */
;
; /* Start:/js/jquery.mask.min.js*/
...
/* End */
;
; /* Start:/bitrix/templates/termo-wood.ru/js/owl-carousel/owl.carousel.js*/
/**
 * Owl Carousel v2.3.4
...
/* End */
;
; /* Start:/bitrix/templates/termo-wood.ru/js/scripts.js*/
$(document).ready(function() {

	//Скрипт слайдера на странице раздела

  $("#owl-profil").owlCarousel({
	paginationSpeed : 400, 
	items : 5, 
	navText:['',''],
	dots:false,
  ...
  //Скрипт слайдера на странице элемента
  $("#owl-elements").owlCarousel({
	autoPlay: 8000, 
	paginationSpeed : 400, 
	items :5, 
	navText:['',''],
...
//Слайдер покрытие
  ...
  $(".owl-pokritye").owlCarousel({
	...
	//Слайдеры товаров на главной каталога
  $("#owl-element-0").owlCarousel({
	paginationSpeed : 400, 
	items : 4, 
	loop: true,
	navText:['',''],
  ...
  $("#owl-element-3").owlCarousel({
	...
	//Слайдер для картинок для главной в моб версии
	$("#owl-mainpage-pictures").owlCarousel({
		autoPlay: 4000,
		paginationSpeed : 400,
		items : 1,
		singleItem:true,
  ...
  //items : 10, //количество элементов
  //temsDesktop : [1000,5], //5 изображений на ширину между 1000px и 901px
  //itemsDesktopSmall : [900,3], // 3 изображения между 900px и 601px
  //itemsTablet: [600,2], //2 изображения между 600 и 0;
  //itemsMobile : false
  //singleItem:true, запрещает изменять количество слайдов при сжатие
...
//Мобильное меню
  ...
  $('.mainMenu__mobile').click(function() {
		element = $('.mainMenu__items-mobile');
		display = element.css('display');
		if(display == 'none')
			$('.mainMenu__items-mobile').slideDown(400);
		if(display == 'block')
			$('.mainMenu__items-mobile').slideUp(400);
	});  


//Сортировка элементов - Проекты
	(function ($) {
	$(window).on("load", function () {
		var masonryGrid = $(".project-items");
	...
	// $(window).on("load", function () {
		// var masonryGrid = $(".pictures");
			// masonryGrid.imagesLoaded(function () {
				// masonryGrid.masonry({
				// itemSelector: ".pictures-project",
				// percentPosition: true
			// });
		// });
	// });
...
//Скрипт слайдера на главной -https://github.com/absentik/jMosaic

//For blocks or images of size, you can use $(document).ready
$(document).ready(function() {
	$('.blocks').jMosaic({items_type: "li", margin: 0});
	// $('.pictures').jMosaic({min_row_height: 150,max_row_height: 150, margin: 0, is_first_big: false});
});
...
/* End */
;
; /* Start:/bitrix/templates/termo-wood.ru/js/imagesloaded.min.js*/
/*!
...
/* End */
;
; /* Start:/bitrix/templates/termo-wood.ru/js/masonry.min.js*/
/*!
...
/* End */
;
; /* Start:/bitrix/templates/termo-wood.ru/js/jmosaic-master/jquery.jMosaic.js*/
/*
...
;(function($, window, document, undefined){
	...
	var defaults = {
		items_type: "div.pictures-project", // Type of elements in the selector 
		min_row_height: 50,  // Minimal row height 
...
/* End */
;
; /* Start:/bitrix/templates/termo-wood.ru/js/pickup/script.js*/
jQuery(document).ready(function(){
		if(localStorage.getItem('PICKUP_POST')=='none') {
		}else{
				set_pickup('#pickup-alarm-additional');
		}
});
function set_pickup(element){
		$(element).addClass('active');
		$(element+' span').html('Мы используем файлы cookie. Подробнее —<br> <a href="/privacy-policy/" rel="nofollow">в нашей политике по обработке персональных данных</a>');
		localStorage.setItem('PICKUP_POST', 'active');
		return false;
}
function close_pickup(element){
		$(element).addClass('none');
		$(element+' span').html('');
		$(element).removeClass('active');
		localStorage.setItem('PICKUP_POST', 'none');
		return false;
}
/* End */
;; /* /bitrix/templates/termo-wood.ru/gallery-project/core.js*/
; /* /bitrix/templates/termo-wood.ru/gallery-project/gallery.js*/
; /* /bitrix/templates/termo-wood.ru/gallery-project/image.js*/
; /* /js/fancybox/source/jquery.fancybox.pack.js*/
; /* /js/fancybox/source/helpers/jquery.fancybox-thumbs.js*/
; /* /js/project.js*/
; /* /js/jquery.mask.min.js*/
; /* /bitrix/templates/termo-wood.ru/js/owl-carousel/owl.carousel.js*/
; /* /bitrix/templates/termo-wood.ru/js/scripts.js*/
; /* /bitrix/templates/termo-wood.ru/js/imagesloaded.min.js*/
; /* /bitrix/templates/termo-wood.ru/js/masonry.min.js*/
; /* /bitrix/templates/termo-wood.ru/js/jmosaic-master/jquery.jMosaic.js*/
; /* /bitrix/templates/termo-wood.ru/js/pickup/script.js*/
